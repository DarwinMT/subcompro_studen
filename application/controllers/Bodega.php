...
class Bodega extends CI_Controller {
	...
	public function save_bodega()
	{
		...
		$id=$this->Bodega_model->saveBodega($data);
		echo $id;
	...
	public function get_bodegas()
	{
		...
		echo json_encode($this->Bodega_model->getlistbodegas($filtro));
	}
	...
	public function edit_estado()
	{
		$this->load->model('Bodega_model');
		$data =  json_decode(file_get_contents("php://input"));
		echo $this->Bodega_model->estadoBodega($data);
	}
	...
	public function edit_bodega()
	{
		$this->load->model('Bodega_model');
		$data =  json_decode(file_get_contents("php://input"));
		echo $this->Bodega_model->updataBodega($data);
	}
}
